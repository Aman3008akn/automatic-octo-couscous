...
const BANNERS = [
  {
    id: 1,
    tag: "SUMMER TECH EVENT",
    title: "Up to 40% Off Electronics & Gadgets",
    subtitle: "Discover high-performance audio, 5G smartphones, and ultralight laptops from verified sellers.",
    ...
    bgGradient: "from-navy-900 via-navy-600 to-navy-900",
  },
  {
    id: 2,
    tag: "VERIFIED PARTNER DEALS",
    title: "Direct Reseller Pricing & Fast Shipping",
    subtitle: "Authenticity guaranteed on every single marketplace purchase with 100% money-back protection.",
    ctaText: "Browse All Deals →",
    ctaUrl: "/search?sortBy=price_asc",
    imageUrl: "https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?w=1200&auto=format&fit=crop",
    bgGradient: "from-amber-600 via-navy-900 to-navy-900",
  },
  {
    id: 3,
    tag: "HOME & KITCHEN ESSENTIALS",
    title: "Modern Home Upgrades Under ₹7,999",
    subtitle: "Smart kettles, digital air fryers, and espresso machines curated for your everyday lifestyle.",
    ctaText: "Shop Home Collection →",
    ctaUrl: "/search?categorySlug=home-kitchen",
    imageUrl: "https://images.unsplash.com/photo-1517668808822-9eaa03afd2af?w=1200&auto=format&fit=crop",
    bgGradient: "from-navy-900 via-navy-400 to-navy-900",
  },
];
