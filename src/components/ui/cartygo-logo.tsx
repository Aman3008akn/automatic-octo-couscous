export function CartygoLogoIcon({ className = "w-10 h-10" }: { className?: string }) {
  return (
    <svg 
      className={className} 
      viewBox="0 0 100 100" 
    ...
    >
      <defs>
        ...
        <linearGradient id="cartygoCBrandGrad" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <linearGradient id="cartygoCartGrad" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#38BDF8" />
          <stop offset="100%" stopColor="#2563EB" />
        </linearGradient>
      </defs>

      {/* Outer bold C shape representing Cartygo - high-contrast amber */}
      <path
        d="M80 28C74 17 62 13 49 13C28 13 13 29 13 50C13 71 28 87 49 87C63 87 74 82 80 71"
        stroke="url(#cartygoCBrandGrad)"
        strokeWidth="13"
        strokeLinecap="round"
      />
...
export const CartigoLogoIcon = CartygoLogoIcon;
