...
interface CartygoLaunchAnimationProps {
  onFinish?: () => void;
  /**
...
export function CartygoLaunchAnimation({
  onFinish,
  durationMs = 2000,
}: CartygoLaunchAnimationProps) {
  ...
  // Amber sweep shimmer across CARTYGO
...
const styles = StyleSheet.create({
  ...
  letterText: {
    fontSize: 42,
    fontWeight: "900",
    color: "#F7F7F5", // Crisp Cartygo Paper
    letterSpacing: 2,
